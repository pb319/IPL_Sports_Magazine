...
-- ** Caution  Edit-> Preferences-> SQL Editor -> read-timeout interval to be atleast 60 seconds **
	...
	GROUP BY batsmanName 
	-- HAVING Total_Balls_Faced >= 60 -- Batsman faced atleast 60 balls
    ...
    -- dot ball % i.e. percentage of dot balls to totla ball
	...
	FROM dim_match) d -- Using subquesry task table has been referenced to tap the `Win_Perc` column
	INNER JOIN task t
	ON d.Team_Name = team
